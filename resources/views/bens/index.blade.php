    ...
    <x-body-page>
        <div class="bg-white overflow-hidden shadow-xs sm:rounded-lg p-6 text-gray-900">
            <div class="container mx-auto px-4 py-8" x-data="">
                ...
                <form method="GET" action="{{ route('bens') }}" class="bg-gray-50 border shadow-md rounded-lg p-6 mb-8">

                    <div class="mb-6">
                        <x-input-label for="search_query" :value="__('Pesquisar')" />
                        <x-text-input id="search_query" name="search_query" type="text" class="mt-1 block w-full"
                        value="{{ request('search_query') }}" placeholder="Patrimônio ou Marca"   />
                    </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 text-gray-500">
                            ...
                            @empty
                                <tr>
                                    <td colspan="6"
                                        class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">Nenhum bem
                                        encontrado.</td>
                                </tr>
                            @endforelse
                        </tbody>
