        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
            <div class="bg-white overflow-hidden shadow-xs sm:rounded-lg">
                <div class="p-6 text-gray-900 max-w-xl">
                    <form method="post" action="{{ route('bens.store') }}" class="space-y-6">
                        @csrf
                        @method('post')
                        <div>
                        ...
                        <div>
                            ...
                            <x-select-input id="responsavel" name="responsavel">
                                <option value="1">Gus</option>
                            </x-select-input>
                        ...
                        <div>
                            ...
                            <x-select-input id="tipoUso" name="tipoUso">
