                ...
                <div class="relative flex space-x-3 sm:space-x-4 items-start">
                    ...
                    <div class="min-w-0 flex-1 bg-gray-50 p-3 sm:p-4 rounded-md border border-gray-100 shadow-sm">
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2">
                            ...
                            <time datetime="{{ $historico->created_at->toIso8601String() }}"
                                class="text-xs sm:text-sm text-gray-500 whitespace-nowrap mt-1 sm:mt-0">
                        ...
                        <div class="space-y-4 text-sm text-gray-700 border-t border-gray-200 pt-3">
                            ...
                            <div class="grid grid-cols-[auto_1fr] gap-x-3">
                                ...
                                <div class="flex flex-col sm:flex-row items-start sm:items-center sm:space-x-2">
                                    @if ($historico->localizacao_anterior)
                                        ...
                                        <svg class="h-4 w-4 text-indigo-500 my-1 sm:hidden"
                                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="2" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="M19.5 13.5 12 21m0 0-7.5-7.5M12 21V3" />
                                        </svg>
                                        <svg class="h-5 w-5 text-indigo-500 hidden sm:block"
                                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    ...
                                    @endif
                                    <span
                                        class="bg-indigo-100 border border-indigo-200 px-2 py-0.5 rounded-full text-indigo-800 font-bold shadow-sm">
                            ...
                            <div class="grid grid-cols-[auto_1fr] gap-x-3">
                                ...
                                <div class="flex flex-col sm:flex-row items-start sm:items-center sm:space-x-2">
                                    ...
                                    @else
                                        <span
                                            class="bg-gray-100 border border-gray-300 px-2 py-0.5 rounded-full text-gray-500 italic shadow-sm">
                                            Usuário Excluído
                                        </span>
                                    @endif
                                </div>
                        ...
                        <p class="text-sm text-gray-500 text-left sm:text-right mt-3 pt-2 border-t border-gray-200">
                            Registrado por: <span
                                class="font-semibold">{{ $historico->registrador->name ?? 'Sistema' }}</span>
                        </p>
                    </div>
                </div>
            </div>
